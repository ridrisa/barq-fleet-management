...
class OperationsSettingsService(
    ...
    """Service for operations settings management"""
    ...
    def set_value(
        ...
        *,
        ...
        setting = self.get_by_key(
            db, setting_key=setting_key, organization_id=organization_id
        )
        if not setting:
            return None
...
class DispatchRuleService(CRUDBase[DispatchRule, DispatchRuleCreate, DispatchRuleUpdate]):
    """Service for dispatch rule management"""
...
class SLAThresholdService(CRUDBase[SLAThreshold, SLAThresholdCreate, SLAThresholdUpdate]):
    """Service for SLA threshold management"""
...
class NotificationSettingService(
    ...
    """Service for notification setting management"""
...
class ZoneDefaultService(CRUDBase[ZoneDefault, ZoneDefaultCreate, ZoneDefaultUpdate]):
    """Service for zone default management"""
    ...
    def set_as_default(self, db: Session, *, default_id: int) -> Optional[ZoneDefault]:
        ...
        db.query(ZoneDefault).filter(ZoneDefault.is_default == True).update(
            {"is_default": False}
        )
...
operations_settings_service = OperationsSettingsService(OperationsSettings)
dispatch_rule_service = DispatchRuleService(DispatchRule)
sla_threshold_service = SLAThresholdService(SLAThreshold)
notification_setting_service = NotificationSettingService(NotificationSetting)
zone_default_service = ZoneDefaultService(ZoneDefault)
