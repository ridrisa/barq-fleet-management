...
from app.utils.analytics import calculate_percentage_change, calculate_distribution
...
def get_maintenance_costs(
    ...
    return {
        ...
        "cost_breakdown": {"parts": 0.0, "labor": 0.0, "external_services": 0.0, "other": 0.0},
        "by_vehicle": [],
        "by_maintenance_type": [],
        "trends": [],
...
def get_downtime_analysis(
    ...
    return {
        ...
        "downtime_by_reason": {"maintenance": 0.0, "repairs": 0.0, "accidents": 0.0, "other": 0.0},
        "by_vehicle": [],
        "trends": [],
        "impact_on_operations": {"missed_deliveries": 0, "estimated_revenue_loss": 0.0},
    }
    ...
    for i in range(min(limit, 10)):
        rankings.append(
            TopPerformerItem(
                ...
                value=100.0 - (i * 5),
                metric_name=metric,
                details={"vehicle_type": "Van", "registration": f"ABC-{1000+i}"},
            )
        )
