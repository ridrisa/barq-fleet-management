...
from app.models.fleet.maintenance import MaintenanceStatus, VehicleMaintenance
from app.schemas.fleet.maintenance import MaintenanceCreate, MaintenanceResponse, MaintenanceUpdate
...
def get_maintenance(
    maintenance_id: int, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
