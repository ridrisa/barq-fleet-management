...
from app.schemas.fleet.courier import CourierCreate, CourierResponse, CourierUpdate
...
def create_courier(
    courier_in: CourierCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
