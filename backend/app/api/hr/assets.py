...
from app.schemas.hr.asset import AssetCreate, AssetResponse, AssetUpdate
...
def create_asset(
    asset_in: AssetCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
    """Create a new asset"""
