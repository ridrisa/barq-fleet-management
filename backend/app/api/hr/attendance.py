...
from app.schemas.hr.attendance import AttendanceCreate, AttendanceResponse, AttendanceUpdate
...
def get_attendance(
    attendance_id: int, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
