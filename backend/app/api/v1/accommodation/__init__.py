...
from app.api.v1.accommodation import building, room, bed, allocation
...
router.include_router(allocation.router, prefix="/allocations", tags=["Accommodation - Allocations"])
