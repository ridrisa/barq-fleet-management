...
router.include_router(route.router, prefix="/routes-old", tags=["Routes"])  # Legacy route
router.include_router(cod.router, prefix="/cod", tags=["COD"])
router.include_router(incident.router, prefix="/incidents-old", tags=["Incidents"])  # Legacy route
