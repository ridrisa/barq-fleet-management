...
tenant_router.include_router(organization.router, prefix="/organizations", tags=["Organizations"])

# Include organization user routes
tenant_router.include_router(
    organization_user.router, prefix="/organizations", tags=["Organization Users"]
)
