...
from app.schemas.accommodation.building import BuildingCreate, BuildingResponse, BuildingUpdate
...
def get_building(
    building_id: int, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
