...
from app.schemas.accommodation.room import RoomCreate, RoomResponse, RoomUpdate
...
def create_room(
    room_in: RoomCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
    """Create a new room"""
